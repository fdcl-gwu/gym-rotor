...
# axs[1, 0].plot(t, Rd2, 'tab:red', label='desired')
axs[1, 0].plot(t, R2, label='response')
axs[1, 0].set_title('$R_2$')
axs[1, 0].set_ylabel('$R_2$ [rad]', size=15)
axs[1, 0].grid(True)
axs[1, 0].legend()

# axs[2, 0].plot(t, Rd3, 'tab:red', label='desired')
axs[2, 0].plot(t, R3, label='response')
axs[2, 0].set_title('$R_3$')
axs[2, 0].set_ylabel('$R_3$ [rad]', size=15)
axs[2, 0].grid(True)
axs[2, 0].legend()
axs[2, 0].set_xlabel('Time [s]', size=15)

# axs[0, 1].plot(t, Rd4, 'tab:red', label='desired')
axs[0, 1].plot(t, R4, label='response')
axs[0, 1].set_title('$R_4$')
axs[0, 1].set_ylabel('$R_4$ [rad]', size=15)
axs[0, 1].grid(True)
axs[0, 1].legend()
...
# axs[2, 1].plot(t, Rd6, 'tab:red', label='desired')
axs[2, 1].plot(t, R6, label='response')
axs[2, 1].set_title('$R_6$')
axs[2, 1].set_ylabel('$R_6$ [rad]', size=15)
axs[2, 1].grid(True)
axs[2, 1].legend()
axs[2, 1].set_xlabel('Time [s]', size=15)

# axs[0, 2].plot(t, Rd7, 'tab:red', label='desired')
axs[0, 2].plot(t, R7, label='response')
axs[0, 2].set_title('$R_7$')
axs[0, 2].set_ylabel('$R_7$ [rad]', size=15)
axs[0, 2].grid(True)
axs[0, 2].legend()

# axs[1, 2].plot(t, Rd8, 'tab:red', label='desired')
axs[1, 2].plot(t, R8, label='response')
axs[1, 2].set_title('$R_8$')
axs[1, 2].set_ylabel('$R_8$ [rad]', size=15)
axs[1, 2].grid(True)
axs[1, 2].legend()
