...
def create_parser():
    ...
    # args of environment:
    parser.add_argument('--framework', default="SARL", help='Name of framework: Single-Agent RL')
    parser.add_argument('--max_steps', default=5000, type=int, help='Maximum number of steps in each episode (default: 2000)')
    parser.add_argument('--max_timesteps', default=int(1e6), type=int, help='Number of total timesteps (default: 7e6)')
    ...
    # args of agents:
    parser.add_argument("--rl_algo", default="SAC", help='Which algorithms? TD3 or SAC (default: TD3)')
    ...
    parser.add_argument("--explor_noise_std_init", default=0.1, type=float, help="Stddev of Gaussian noise for exploration")
    ...
    parser.add_argument('--automatic_entropy_tuning', type=bool, default=True, metavar='G', help="Enable automatic tuning of α (default: False)")
    ...
    parser.add_argument('--lam_M', default=0.1, type=int, metavar='N', help='Magnitude Smoothness (default: 0.2~0.5)')
